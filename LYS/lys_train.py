...
#        print("accel: ", self.R['accel'], "brake: ", self.R['brake'])
...
def preTrain(): # train the NN of actor and ciritc using existing rules
    ...
    vision = False
    episode_count = 5
#    episode_count = 2000                    # Episode count ************************
    max_steps = 100000
    reward = 0
    done = False
    step = 0
    ...
    try:
        actor.model.load_weights("1pre_actormodel.h5")
        critic.model.load_weights("1pre_criticmodel.h5")
        actor.target_model.load_weights("1pre_actormodel.h5")
        critic.target_model.load_weights("1pre_criticmodel.h5")
   ...
   #     if(race_success):                                    # This part is about terminating episode
   #         break
        before_reward= 0
...
#************************************************************************
#            print("*****ob : ",ob,", r_t : ",r_t,", done : ",done,", info : ",info,"*****")
...
#  *************************************************************************************
            ...
            print("Before Rewards",before_reward,"Rewards",r_t)          
            ...
            if done:
                break
            if before_reward >=0 and before_reward==r_t:
                race_success = True
                break
            before_reward = r_t
